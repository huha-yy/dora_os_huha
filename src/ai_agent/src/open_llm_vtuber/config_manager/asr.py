...
class SherpaOnnxASRConfig(I18nMixin):
    ...
    hotwords_file: Optional[str] = Field("", alias="hotwords_file")
    hotwords_score: float = Field(1.5, alias="hotwords_score")
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "hotwords_file": Description(
            en="Path to hotwords file", zh="热词文件路径"
        ),
        "hotwords_score": Description(
            en="Hotwords score", zh="热词分数"
        ),
