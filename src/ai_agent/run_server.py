...
def parse_args():
    ...
    parser.add_argument("--lang", action="store", default="en", help="Select language")
...
def run(console_log_level: str):
    ...
    config: Config = validate_config(read_yaml(str(config_path)))
...
if __name__ == "__main__":
    args = parse_args()
    upgrade_manager = UpgradeManager(lang=args.lang)
