...
# Get the ai_agent directory (parent of upgrade_codes directory)
AI_AGENT_DIR = Path(__file__).parent.parent.parent

USER_CONF = str(AI_AGENT_DIR / "conf.yaml")
BACKUP_CONF = str(AI_AGENT_DIR / "conf.yaml.backup")

ZH_DEFAULT_CONF = str(AI_AGENT_DIR / "config_templates" / "conf.ZH.default.yaml")
EN_DEFAULT_CONF = str(AI_AGENT_DIR / "config_templates" / "conf.default.yaml")
